...
const TopDoctor = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-800 md:mx-10">
      ...
      <button onClick={() => navigate('/doctors')} className="border-gray-200 text-gray-400 mt-10 border px-8 py-2 sm:px-12 sm:py-3 rounded-full shadow-lg hover:text-[#f9755b] hover:scale-110 transition-all duration-500">See More</button>
    </div>
  )
}
