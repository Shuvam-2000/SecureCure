...
const Header = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-[#192de2] rounded-lg px-6 md:px-10 lg:px-20 py-8 mt-2">
      ...
      <div className="md:w-1/2 flex flex-col items-start justify-center gap-4">
          ...
          <button onClick={() => navigate('/doctors')} className="sm:mt-4 mt-2 mb-4 inline-flex items-center bg-white text-[#4051ec] font-semibold sm:py-2 sm:px-4 
